  ...
  <body>
    ...
    <div class="banner header-text">
      <div class="owl-banner owl-carousel">
        ...
        <div class="text-content">
            <h2 style="width:700px;margin:auto; box-shadow: 1px 2px 4px 5px;background-color:#f33f3f;color:aliceblue">Selamat Datang</h2>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-12 ">   
            <div class="section-heading">
              ...
              <a  class="btn btn-danger" href="pemesanan.php"style="color:#fff;padding:10px">Lakukan Pemesanan Meja <i class="fa fa-angle-right"></i></a>
            </div>
          </div>
