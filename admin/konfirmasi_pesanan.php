  ...
  <body>
   ...
   <div class="container">
    <div class="containerr">
        <h1 class="text-center">Daftar Pesanan Yang Belum Dikonfirmasi</h1>
    ...
    $id =$_SESSION["user"]["id"];        
    $sql = "SELECT * FROM pembayaran INNER JOIN pemesanan_meja on pembayaran.id_pemesanan = pemesanan_meja.id where status='Tunggu Konfirmasi'";
    ...
    <td scope="row">
    <a href="konfirmasi.php?id=<?php echo $id; ?>"><button type="button" class="btn btn-warning">Konfirmasi</button></a> <br> <br>
